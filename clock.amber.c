...
main(int, char**)
{
	...
	hrhand = allocimage(display, Rect(0,0,1,1), RGB24, 1, 0xFFD70BFF);
	minhand = allocimage(display, Rect(0,0,1,1), RGB24, 1, 0xFFD70BFF);
	dots = allocimage(display, Rect(0,0,1,1), RGB24, 1, 0xFFD70BFF);
	redraw(screen);
