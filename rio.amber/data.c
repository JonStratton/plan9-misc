...
iconinit(void)
{
	...
	cols[BORD] = allocimage(display, Rect(0,0,1,1), CMAP8, 1, 0x937C06FF);
	cols[HIGH] = allocimage(display, Rect(0,0,1,1), CMAP8, 1, 0xFFD70BFF);
	cols[TEXT] = allocimage(display, Rect(0,0,1,1), CMAP8, 1, 0xFFD70BFF);
	titlecol = allocimage(display, Rect(0,0,1,1), CMAP8, 1, 0xFFD70BFF);
	lighttitlecol = allocimage(display, Rect(0,0,1,1), CMAP8, 1, 0x937C06FF);
	paletextcol = allocimage(display, Rect(0,0,1,1), CMAP8, 1, 0x937C06FF);
